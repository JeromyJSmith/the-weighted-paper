...
const VARIANTS = {
  ...
  V3: { name: 'Two-tier', nick: 'one choice', comp: '1 Core · 1 Bonus · 3 Serious', max: 2, min: -2, pass: 1, headroom: 1,
  ...
  V4: { name: 'Nine-option zero-sum', nick: 'nine boxes', comp: '2 Core · 2 Bonus · 4 Poor · 1 Serious', max: 6, min: -6, pass: 4, headroom: 2,
  ...
  V6: { name: 'Sole-positive', nick: 'one right action', comp: '1 Core · 3 Serious', max: 2, min: -2, pass: 2, headroom: 0,
